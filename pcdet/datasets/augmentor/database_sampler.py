...
class DataBaseSampler(object):
    def __init__(self, root_path, sampler_cfg, class_names, logger=None):
        ...
        for x in sampler_cfg.SAMPLE_GROUPS:  # ['stone:15']
    ...
    def add_sampled_boxes_to_scene(self, data_dict, sampled_gt_boxes, total_valid_sampled_dict):
        ...
        for idx, info in enumerate(total_valid_sampled_dict):
            ...
            obj_points[:, :3] += info['box3d_lidar'][:3]  # 还原绝对坐标,因为之前create_groundtruth_database中减过
    ...
    def __call__(self, data_dict):
        ...
        for class_name, sample_group in self.sample_groups.items():  # ['stone:15']
            ...
            if int(sample_group['sample_num']) > 0:  # 如果采样box的数量大于0
                sampled_dict = self.sample_with_fixed_number(class_name,
                                                             sample_group)  # 在db_infos[calss_name]中随机采样sample_num 50 个box信息
        ...
        # print(data_dict)
        return data_dict
# {'frame_id': '000010', 'gt_names': array(['stone', 'stone', 'stone', 'stone', 'stone', 'stone', 'stone',
#        'stone', 'stone', 'stone', 'stone', 'stone', 'stone', 'stone',
#        'stone', 'stone', 'stone', 'stone', 'stone', 'stone', 'stone',
#        'stone', 'stone', 'stone', 'stone', 'stone', 'stone', 'stone',
#        'stone', 'stone', 'stone', 'stone', 'stone'], dtype='<U5'),}

# {'frame_id': '000014', 'gt_names': array(['stone', 'stone', 'stone', 'stone', 'stone', 'stone', 'stone',
#        'stone', 'stone', 'stone'], dtype='<U5'),}
