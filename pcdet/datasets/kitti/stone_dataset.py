...
class StoneDataset(DatasetTemplate):
    # 初始化参数
...
def create_stone_infos(dataset_cfg, class_names, data_path, save_path, workers=4):
    dataset = StoneDataset(dataset_cfg=dataset_cfg, class_names=class_names, root_path=data_path, training=False)
...
if __name__ == '__main__':
    ...
    if sys.argv.__len__() > 1 and sys.argv[1] == 'create_stone_infos':
        import yaml
        from pathlib import Path
        ...
        create_stone_infos(
            ...
            class_names=['stone'],
            data_path=ROOT_DIR / 'data' / 'stone',
            save_path=ROOT_DIR / 'data' / 'stone'
        )
